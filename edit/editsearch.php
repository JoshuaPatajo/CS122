...
<html lang="en">
  <head>
    ...
    <title>Search to Edit</title>

    <!-- CSS -->
    <link rel="stylesheet" href="editsearch.css?version=2">
...
if(isset($_POST["submit"])) {
  ...
  <td><a href=editdata.php?ID={$row['studentID']}>Edit</a></td></tr>";
  }
  echo "</table></div>";
}
?>
