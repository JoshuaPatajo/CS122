...
<html lang="en">
  ...
  <body>
    ...
    <div id="container">
      <a href="../add/add.php"><div class="card hvr-float" ><i class="fas fa-user"></i> Add Individual</div></a>
      <a href="../addg/addg.php"><div class="card hvr-float"><i class="fas fa-users"></i> Add by Group</div></a>
